...
const App = () => {
  ...
  const { createLog, handleSaveTask, handleOpenModal, handleAddSubtask, handleToggleSubtask, handleDeleteSubtask, toggleAssignee, toggleTaskTag } = useTaskActions(
    tasks, setTasks,
